...
public class BoardPanel extends JPanel {
    ...
    public BoardPanel(List<Pit> pits, Pit mancalaA, Pit mancalaB, BoardPatternStrategy boardPattern) {
        ...
        setPreferredSize(new Dimension(1280, 720)); // Adjusted size for a more balanced board
        ...
        mancalaA.setBounds(760, 30, mancalaWidth, mancalaHeight); // Centered vertically
        ...
        for (int i = 0; i < 6; i++) {
            Pit pit = pits.get(6 + i); // Player A's pits (left to right)
